...
extension PXOneTapViewController {
    ...
    fileprivate func renderViews() {
        ...
        let rowView = PXSummaryRowComponent(props: (title: "AySA", subTitle: "Factura agua", rightText: "$ 1200", backgroundColor: nil)).oneTapRender()
        ...
        let rowView2 = PXSummaryRowComponent(props: (title: "Edenor", subTitle: "Pago de luz mensual", rightText: "$ 400", backgroundColor: nil)).oneTapRender()
