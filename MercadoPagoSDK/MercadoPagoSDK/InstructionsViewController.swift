...
open class InstructionsViewController: MercadoPagoUIViewController, UITableViewDataSource, UITableViewDelegate {
    ...
    open func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        ...
        let attributes: [String:AnyObject] = [NSFontAttributeName : UIFont(name:MercadoPagoContext.getDecorationPreference().getFontName(), size: 14) ?? UIFont.systemFont(ofSize: 14),NSForegroundColorAttributeName: UIColor.UIColorFromRGB(0x0066CC)]
