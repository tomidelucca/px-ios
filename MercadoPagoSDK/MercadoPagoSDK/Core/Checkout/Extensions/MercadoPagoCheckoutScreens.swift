...
extension MercadoPagoCheckout {
    ...
    func showIdentificationScreen() {
        let identificationStep = IdentificationViewController (identificationTypes: self.viewModel.identificationTypes!, paymentData: viewModel.paymentData, callback: { [weak self] (identification : PXIdentification) in
            guard let strongSelf = self else {
                return
            }
