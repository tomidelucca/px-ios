...
@objcMembers open class PaymentResultScreenPreference: NSObject {
    ...
    var approvedIconBundle = ResourcesManager.shared.getBundle()!
    ...
    var pendingIconBundle = ResourcesManager.shared.getBundle()!
    ...
    var rejectedIconBundle = ResourcesManager.shared.getBundle()!
    ...
    var pmIconBundle = ResourcesManager.shared.getBundle()!
    ...
    open func getApprovedBadgeImage() -> UIImage? {
        ...
        if badge == ApprovedBadge.check {
            return ResourcesManager.shared.getImage("ok_badge")
    ...
    open func getHeaderApprovedIcon() -> UIImage? {
        ...
        return ResourcesManager.shared.getImage(approvedIconName)
    }
    ...
    open func getHeaderPendingIcon() -> UIImage? {
        ...
        return ResourcesManager.shared.getImage(pendingIconName)
    }
    ...
    open func getHeaderRejectedIcon(_ paymentMethod: PaymentMethod?) -> UIImage? {
        ...
        if rejectedIconName != nil {
            return ResourcesManager.shared.getImage(rejectedIconName)
        }
    ...
    open func getHeaderImageFor(_ paymentMethod: PaymentMethod?) -> UIImage? {
        guard let paymentMethod = paymentMethod else {
            return ResourcesManager.shared.getImage(pmDefaultIconName)
        }

        if paymentMethod.isBolbradesco {
            return ResourcesManager.shared.getImage(pmBolbradescoIconName)
        }

        if paymentMethod.paymentTypeId == PaymentTypeId.PAYMENT_METHOD_PLUGIN.rawValue {
            return ResourcesManager.shared.getImage(rejectedPaymentMethodPluginIconName)
        }
        return ResourcesManager.shared.getImage(pmDefaultIconName)
    }
...
extension MercadoPagoCheckout {
    internal class func showPayerCostDescription() -> Bool {
        let path = ResourcesManager.shared.getBundle()!.path(forResource: "PayerCostPreferences", ofType: "plist")
