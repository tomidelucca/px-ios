...
open class ErrorViewController: MercadoPagoUIViewController {
   ...
   open static var defaultErrorCancel : ((Void) -> Void)?
    ...
    override open func viewDidLoad() {
        ...
        let normalAttributes: [String:AnyObject] = [NSFontAttributeName : UIFont(name:MercadoPagoContext.getDecorationPreference().getFontName(), size: 14) ?? UIFont.systemFont(ofSize: 14)]
