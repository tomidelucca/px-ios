...
class AuthorizePaymentHeaderTableViewCell: UITableViewCell, CongratsFillmentDelegate {
    ...
    func getCellHeight(_ payment : Payment, paymentMethod : PaymentMethod) -> CGFloat {
        ...
        let attributesTitle = [NSFontAttributeName: UIFont(name: MercadoPagoContext.getDecorationPreference().getFontName(), size: 22) ?? UIFont.systemFont(ofSize: 22)]
        ...
        let attributesSubtitle = [NSFontAttributeName: UIFont(name: MercadoPagoContext.getDecorationPreference().getFontName(), size: 14) ?? UIFont.systemFont(ofSize: 14)]
