...
public class IssuerCardViewController: MercadoPagoUIViewController {
    ...
    override func loadMPStyles(){
        ...
        if self.navigationController != nil {
            ...
            let titleDict: NSDictionary = [NSForegroundColorAttributeName: UIColor.systemFontColor(), NSFontAttributeName: UIFont(name: MercadoPago.DEFAULT_FONT_NAME, size: 18) ?? UIFont.systemFontOfSize(18)]
