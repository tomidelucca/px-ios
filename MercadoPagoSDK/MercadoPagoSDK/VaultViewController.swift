...
public class VaultViewController : MercadoPagoUIViewController, UITableViewDataSource, UITableViewDelegate {
    ...
    public var callback : ((_ : PaymentMethod, _ : String?, _ : Issuer?, _: Int) -> Void)?
    ...
    init(amount: Double, paymentPreference : PaymentPreference?, callback: (_ : PaymentMethod, _ : String?, _ : Issuer?, installments: Int) -> Void) {
