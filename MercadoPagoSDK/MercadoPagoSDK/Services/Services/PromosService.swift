...
internal class PromosService: MercadoPagoService {
	...
	internal func getPromos(_ url: String = PXServicesURLConfigs.MP_PROMOS_URI, method: String = "GET", public_key: String, success: @escaping (_ data: Data?) -> Void, failure: ((_ error: PXError) -> Void)?) {
