...
internal class IdentificationService: MercadoPagoService {
    ...
    internal func getIdentificationTypes(_ method: String = "GET", uri: String = PXServicesURLConfigs.MP_IDENTIFICATION_URI, success: @escaping (_ data: Data?) -> Void, failure: ((_ error: PXError) -> Void)?) {
