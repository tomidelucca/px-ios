...
class PXFooterRenderer: NSObject {
    ...
    func buildPrincipalButton(with footerAction: PXAction, color: UIColor? = .pxBlueMp) -> UIButton {
    ...
    func buildLinkButton(with footerAction: PXAction, color: UIColor? = .pxBlueMp) -> UIButton {
