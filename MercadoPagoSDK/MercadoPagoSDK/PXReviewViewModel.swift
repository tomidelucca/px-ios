...
class PXReviewViewModel: NSObject {
    ...
    func trackCancelEvent() {
        // No tracking for cancel event in review view controller for now
    }
}
...
final class PXOneTapViewModel: PXReviewViewModel {
    override var screenName: String { return TrackingUtil.SCREEN_NAME_REVIEW_AND_CONFIRM }
    ...
    override func trackCancelEvent() {
        MPXTracker.sharedInstance.trackActionEvent(action: TrackingUtil.ACTION_ONE_TAP_CHECKOUT_CANCEL, screenId: screenId, screenName: screenName)
    }
}
