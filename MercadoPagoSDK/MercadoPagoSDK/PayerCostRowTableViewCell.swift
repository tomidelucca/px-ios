...
class PayerCostRowTableViewCell: UITableViewCell {
    ...
    func fillCell(payerCost : PayerCost) {
        ...
        let atribute = [NSFontAttributeName : UIFont(name:MercadoPagoContext.getDecorationPreference().getFontName(), size: 20) ?? UIFont.systemFont(ofSize: 20),NSForegroundColorAttributeName: UIColor.black]
