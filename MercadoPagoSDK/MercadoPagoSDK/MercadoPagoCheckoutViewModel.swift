...
//
    ...
    public func issuerViewModel() -> AdditionalStepViewModel{
        ...
        return IssuerAdditionalStepViewModel(screenName: "ISSUER", screenTitle: "¿Quién emitió tu tarjeta?".localized, cardSectionVisible: true, cardSectionView: IdentificationCardView(frame: self.cardViewRect), totalRowVisible: false, amount: self.getAmount(), token: self.cardToken, paymentMethods: pms, dataSource: self.issuers!)
