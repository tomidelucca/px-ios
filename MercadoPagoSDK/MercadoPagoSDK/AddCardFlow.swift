...
public class AddCardFlow: NSObject, PXFlow {
    ...
    private func openCardForm() {
        ...
        let cardFormViewModel = CardFormViewModel(paymentMethods: paymentMethods, guessedPaymentMethods: nil, customerCard: nil, token: nil, mercadoPagoServicesAdapter: nil)
