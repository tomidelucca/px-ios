    ...
    func render(header : HeaderComponent ) -> UIView {
       ...
       // image.rounded()
        ...
        if (header.labelText != nil) {
            ...
            statusLabel.attributedText = header.labelText
        ...
        messageLabel.attributedText = header.title
        ...
        let height = UILabel.requiredHight(forText: header.title.string, withFont: messageLabel.font  , inWidth: screenWidth)
