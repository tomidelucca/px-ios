...
public class CardFormViewController: MercadoPagoUIViewController, UITextFieldDelegate, UIGestureRecognizerDelegate {
            ...
            if(textField.text?.characters.count == 5) {
                if(!isAmexCard()) {
                    ...
                    dispatch_after(delayTime, dispatch_get_main_queue()) {
                        ...
                        UIView.transitionFromView(self.cardFront!, toView: self.cardBack!, duration: 1, options: UIViewAnimationOptions.TransitionFlipFromRight, completion: { (_) -> Void in
            ...
            if(textField.text?.characters.count == 3) {
                if(!isAmexCard()) {
                    ...
                    dispatch_after(delayTime, dispatch_get_main_queue()) {
                        ...
                        UIView.transitionFromView(self.cardBack!, toView: self.cardFront!, duration: 1, options: UIViewAnimationOptions.TransitionFlipFromLeft, completion: { (_) -> Void in
    ...
    func leftArrowKeyTapped() {
        ...
        case cvvLabel! :
            ...
            UIView.transitionFromView(self.cardBack!, toView: self.cardFront!, duration: 1, options: UIViewAnimationOptions.TransitionFlipFromRight, completion: { (_) -> Void in
                self.promoButton.alpha = 1
                self.promoButton.enabled = true
            })
