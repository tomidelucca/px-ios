...
class ExamplesUtils {
    ...
    class func startCardActivity(_ merchantPublicKey: String, paymentMethod: PaymentMethod, callback: (_ token: Token?) -> Void) -> CardViewController {
        return CardViewController(merchantPublicKey: merchantPublicKey, paymentMethod: paymentMethod, callback: callback)
    }
    
    class func startSimpleVaultActivity(_ merchantPublicKey: String, merchantBaseUrl: String, merchantGetCustomerUri: String, merchantAccessToken: String, paymentPreference: PaymentPreference?, callback: (_ paymentMethod: PaymentMethod, _ token: Token?) -> Void) -> SimpleVaultViewController {
    ...
    class func startAdvancedVaultActivity(_ merchantPublicKey: String, merchantBaseUrl: String, merchantGetCustomerUri: String, merchantAccessToken: String, amount: Double, paymentPreference: PaymentPreference?, callback: (_ paymentMethod: PaymentMethod, _ token: String?, _ issuer: Issuer?, _ installments: Int) -> Void) -> AdvancedVaultViewController {
    ...
    class func startFinalVaultActivity(_ merchantPublicKey: String, merchantBaseUrl: String, merchantGetCustomerUri: String, merchantAccessToken: String, amount: Double, paymentPreference: PaymentPreference?, callback: (_ paymentMethod: PaymentMethod, _ token: String?, _ issuer: Issuer?, _ installments: Int) -> Void) -> FinalVaultViewController {
