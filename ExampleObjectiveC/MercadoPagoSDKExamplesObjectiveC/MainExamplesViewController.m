...
//
    ...
    self.checkoutBuilder = [[MercadoPagoCheckoutBuilder alloc] initWithPublicKey:@"APP_USR-648a260d-6fd9-4ad7-9284-90f22262c18d" checkoutPreference:self.pref paymentConfiguration:[self getPaymentConfiguration]];
